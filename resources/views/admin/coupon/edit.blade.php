                                ...
                                <div class="ec-vendor-upload-detail">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control slug-title" placeholder="Name" value="{{ $coupon->name}}" name="name">
                                            @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <label for="discountPercent" class="form-label">Discount
                                                percent</label>
                                            <input type="number" class="form-control" placeholder="discountPercent" value="{{$coupon->discount_percent }}" name="discount_percent" min="0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" placeholder="startDate" min="0" id="startDate" value="{{ $coupon->start_date }}" name="start_date">
                                            @error('start_date')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" placeholder="endDate" min="0" id="startDate" value="{{ $coupon->end_date }}" name="end_date">
                                            @error('end_date')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" rows="2" name="description"> {{ $coupon->description}}</textarea>
                                        </div>
                                        <div class="form-group col-12 form-check form-switch m-3">
                                            <input class="form-check-input" type="checkbox" role="switch" id="isActived" name="is_active" {{ $coupon->is_active ? 'checked' : '' }}>
