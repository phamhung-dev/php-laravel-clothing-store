...
<head>
    ...
    <title>403 Access Denied- AndShop</title>
    <!-- Bootstrap CSS -->
...
<body>
    <!-- Error-Area -->
    <section id="error_area" class="ptb-100" style="padding-top: 250px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="erorr_wrapper">
                        <h1>403</h1>
                        <h3>We are sorry, you cannot access this page</h3>
                        <a href="{{route('home')}}" class="theme-btn-one btn-black-overlay btn_md">Back To Home Page</a>
                    </div>
                </div>
            </div>
        </div>
